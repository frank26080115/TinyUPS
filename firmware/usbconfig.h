...
**/
#if defined(ENABLE_UPS_REPORTS) && defined(ENABLE_DEBUG_REPORTS)
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH (296 + 23)
#elif defined(ENABLE_UPS_REPORTS) && !defined(ENABLE_DEBUG_REPORTS)
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH (296)
#elif !defined(ENABLE_UPS_REPORTS) && defined(ENABLE_DEBUG_REPORTS)
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH (23)
#endif
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH_H (USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH >> 8)
